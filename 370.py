"""
FAKE TEST CASE - how can pickup be after dropoff? - Bryant
...
def get_total_time(deliveries):
    pickups = []
    dropoffs = []
    for delivery in deliveries:
        if delivery[2] == 'pickup':
            pickups.append(delivery[1])
        else:
            dropoffs.append(delivery[1])

    print(pickups)
    print(dropoffs)
    print(sum(pickups) - sum(dropoffs))
